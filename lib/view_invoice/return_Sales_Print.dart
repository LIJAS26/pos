...
class _mytestState extends State<return_salesPrint> {
  ...
  initSavetoPath() async {
    ...
    const filename = 'Point Plus Logo app.png';
    const filename1 = 'print.png';
    var bytes = await rootBundle.load("assets/Point Plus Logo app.png");
    var bytes1 = await rootBundle.load("assets/Point Plus Logo app.png");
